//link al video: https://www.youtube.com/watch?v=vB7sGO02bQw&ab_channel=AlanCarabajal
//DATOS DE LOS ALUMNOS:
//NOMBRE: Uma Lara Feoli (119020/6) y Alan Carabajal (118986/1)
//COMISION: Comision 3
...
function setup() {
  ...
  sonidoMusica = document.getElementById("sonido-musica"); ///obtiene el sonido de HTML
}
...
function draw() {
  ...
  if (estado === 0) {
   pantallaInicio(); 
    ...
    pantallaDosBotones();
  }else if (estado === 5 || estado === 6 || estado === 7 || estado === 8 ||  estado === 10) {
    pantallaUnBoton();
